...
trait CAPSEntity extends CypherEntity[Long] {
  type I = CAPSEntity
}
...
case class CAPSNode(
  ...
  override val properties: CypherMap = CypherMap.empty) extends CAPSEntity with CypherNode[Long] {
...
case class CAPSRelationship(
  ...
  override val properties: CypherMap = CypherMap.empty) extends CAPSEntity with CypherRelationship[Long] {
