...
public interface CypherListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_ReadOnlyEnd}.
	 * @param ctx the parse tree
	 */
	void enterOC_ReadOnlyEnd(CypherParser.OC_ReadOnlyEndContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_ReadOnlyEnd}.
	 * @param ctx the parse tree
	 */
	void exitOC_ReadOnlyEnd(CypherParser.OC_ReadOnlyEndContext ctx);
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_ReadUpdateEnd}.
	 * @param ctx the parse tree
	 */
	void enterOC_ReadUpdateEnd(CypherParser.OC_ReadUpdateEndContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_ReadUpdateEnd}.
	 * @param ctx the parse tree
	 */
	void exitOC_ReadUpdateEnd(CypherParser.OC_ReadUpdateEndContext ctx);
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_UpdatingEnd}.
	 * @param ctx the parse tree
	 */
	void enterOC_UpdatingEnd(CypherParser.OC_UpdatingEndContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_UpdatingEnd}.
	 * @param ctx the parse tree
	 */
	void exitOC_UpdatingEnd(CypherParser.OC_UpdatingEndContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_ReadPart}.
	 * @param ctx the parse tree
	 */
	void enterOC_ReadPart(CypherParser.OC_ReadPartContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_ReadPart}.
	 * @param ctx the parse tree
	 */
	void exitOC_ReadPart(CypherParser.OC_ReadPartContext ctx);
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_UpdatingPart}.
	 * @param ctx the parse tree
	 */
	void enterOC_UpdatingPart(CypherParser.OC_UpdatingPartContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_UpdatingPart}.
	 * @param ctx the parse tree
	 */
	void exitOC_UpdatingPart(CypherParser.OC_UpdatingPartContext ctx);
	/**
	 * Enter a parse tree produced by {@link CypherParser#oC_UpdatingStartClause}.
	 * @param ctx the parse tree
	 */
	void enterOC_UpdatingStartClause(CypherParser.OC_UpdatingStartClauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link CypherParser#oC_UpdatingStartClause}.
	 * @param ctx the parse tree
	 */
	void exitOC_UpdatingStartClause(CypherParser.OC_UpdatingStartClauseContext ctx);
	/**
