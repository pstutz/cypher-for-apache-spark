...
public interface CypherVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_ReadOnlyEnd}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_ReadOnlyEnd(CypherParser.OC_ReadOnlyEndContext ctx);
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_ReadUpdateEnd}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_ReadUpdateEnd(CypherParser.OC_ReadUpdateEndContext ctx);
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_UpdatingEnd}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_UpdatingEnd(CypherParser.OC_UpdatingEndContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_ReadPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_ReadPart(CypherParser.OC_ReadPartContext ctx);
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_UpdatingPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_UpdatingPart(CypherParser.OC_UpdatingPartContext ctx);
	/**
	 * Visit a parse tree produced by {@link CypherParser#oC_UpdatingStartClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOC_UpdatingStartClause(CypherParser.OC_UpdatingStartClauseContext ctx);
	/**
